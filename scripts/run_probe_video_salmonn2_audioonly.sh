#!/bin/bash
# =============================================================================
# OmniProact-Bench — Video-SALMONN 2+ 7B (Audio-Only) Probe Evaluation
# =============================================================================
# Audio-only ablation: model receives ONLY audio track, no video frames.
# Same deps as run_probe_video_salmonn2.sh (transformers 4.51 shim, etc.)
#
# Usage:
#   bash scripts/run_probe_video_salmonn2_audioonly.sh          # Full run
#   LIMIT=2 bash scripts/run_probe_video_salmonn2_audioonly.sh  # Quick test
# =============================================================================

set -e

MODEL="video-salmonn2+-audioonly"
MODEL_TAG="Video-SALMONN2plus-7B-AudioOnly"
...
echo "  (Audio-Only ablation)"                     | tee -a "$LOG"
echo "==========================================" | tee -a "$LOG"
...
echo "" | tee -a "$LOG"
echo "[Step 3] Running probe evaluation (Audio-Only)..." | tee -a "$LOG"
