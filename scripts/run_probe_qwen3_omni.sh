#!/bin/bash
# =============================================================================
# OmniProact-Bench — Qwen3-Omni-30B-A3B-Instruct (Audio ON) Full Probe
# =============================================================================
# Usage:
#   bash scripts/run_probe_qwen3_omni.sh          # Full run
#   LIMIT=2 bash scripts/run_probe_qwen3_omni.sh  # Quick test
# =============================================================================

set -e

MODEL="qwen3-omni"
MODEL_TAG="Qwen3-Omni-30B-A3B-Instruct"
