#!/bin/bash
# =============================================================================
# OmniProact-Bench — Gemini-3-Flash-Preview (NoAudio) Full Probe
# =============================================================================
# Usage:
#   bash scripts/run_probe_gemini_noaudio.sh          # Full run
#   LIMIT=2 bash scripts/run_probe_gemini_noaudio.sh  # Quick test
# =============================================================================

set -e

MODEL="gemini-3-flash-noaudio"
MODEL_TAG="gemini-3-flash-preview-NoAudio"
