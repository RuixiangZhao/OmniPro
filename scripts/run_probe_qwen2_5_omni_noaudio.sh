#!/bin/bash
# =============================================================================
# OmniProact-Bench — Qwen2.5-Omni-7B (NoAudio) Full Probe Evaluation
# =============================================================================
# Usage:
#   bash scripts/run_probe_qwen2_5_omni_noaudio.sh          # Full run
#   LIMIT=2 bash scripts/run_probe_qwen2_5_omni_noaudio.sh  # Quick test
# =============================================================================

set -e

MODEL="qwen2.5-omni-noaudio"
MODEL_TAG="Qwen2.5-Omni-7B-NoAudio"
