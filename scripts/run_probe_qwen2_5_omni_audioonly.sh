#!/bin/bash
# =============================================================================
# OmniProact-Bench — Qwen2.5-Omni-7B (Audio-Only) Probe Evaluation
# =============================================================================
# Audio-only ablation: model receives ONLY audio track, no video frames.
#
# Usage:
#   bash scripts/run_probe_qwen2_5_omni_audioonly.sh          # Full run
#   LIMIT=2 bash scripts/run_probe_qwen2_5_omni_audioonly.sh  # Quick test
# =============================================================================

set -e

MODEL="qwen2.5-omni-audioonly"
MODEL_TAG="Qwen2.5-Omni-7B-AudioOnly"
