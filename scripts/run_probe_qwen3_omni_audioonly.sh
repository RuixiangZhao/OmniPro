#!/bin/bash
# =============================================================================
# OmniProact-Bench — Qwen3-Omni-30B-A3B-Instruct (Audio-Only) Probe
# =============================================================================
# Audio-only ablation: model receives ONLY audio track, no video frames.
#
# Usage:
#   bash scripts/run_probe_qwen3_omni_audioonly.sh          # Full run
#   LIMIT=2 bash scripts/run_probe_qwen3_omni_audioonly.sh  # Quick test
# =============================================================================

set -e

MODEL="qwen3-omni-audioonly"
MODEL_TAG="Qwen3-Omni-30B-A3B-Instruct-AudioOnly"
